...
var callingPython = require("../controllers/callingPython.Controller");
const { check, validationResult } = require('express-validator');

const {VerifyToken}  = require('../middleware/middleware.js'); //Bug Fix
module.exports = (app) => {
    app.post("/signup", [
    ...
    app.get("/get/pythonScript",  
    VerifyToken,
    (req, res) => {
        callingPython.readPython(req, res)
    });
};